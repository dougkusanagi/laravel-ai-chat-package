...
<div x-data="aiChat" x-cloak class="fixed z-50 bg-white right-4 bottom-4 dark:bg-background">
    <!-- Chat Container -->
    <div x-show="laravelAiChatIsOpen" x-transition:enter="transition ease-out duration-300"
        ...
        :class="laravelAiChatIsMinimized ? 'h-[400px]' : 'h-[600px]'">
        <!-- Chat Header -->
        <div
            ...
            <div class="flex gap-1">
                <button @click="laravelAiChatIsMinimized = !laravelAiChatIsMinimized"
                    ...
                    <template x-if="!laravelAiChatIsMinimized">
                ...
                <button @click="laravelAiChatIsOpen = false"
                    class="flex items-center justify-center w-8 h-8 text-gray-600 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-gray-400">
                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
        ...
        <!-- Chat Messages -->
        <div class="flex-1 p-4 space-y-4 overflow-y-auto bg-gray-50 dark:bg-gray-900" id="laravel-ai-chat-messages">
            ...
            <div x-show="laravelAiChatIsLoading" class="flex items-center justify-center py-4">
        ...
        <div class="p-4 bg-white border-t border-gray-200 dark:border-white/10 dark:bg-gray-800">
            <form @submit.prevent="sendMessage" class="flex gap-2">
                <input type="text" x-model="newMessage"
                    ...
                    placeholder="Type your message..." :disabled="laravelAiChatIsLoading" />
                <button type="submit"
                    ...
                    :disabled="laravelAiChatIsLoading">
                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round">
    ...
    <!-- Chat Toggle Button -->
    <div x-show="!laravelAiChatIsOpen">
        <button @click="laravelAiChatIsOpen = true"
